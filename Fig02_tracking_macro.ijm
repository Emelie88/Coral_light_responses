...
// videos must already have background subtracted
// and be thresholded manually before running this macro
...
// ADD INFO HERE!! 
        numFramesToProcess = 100 ;  //  number of frames to process (e.g. 50 is 5 sec at 10 fps)
...
// check and amend these parameters manually before you batch process
    run("MTrack2 ", "minimum=100 maximum=3000 maximum_=20 minimum_=100 display"); 
